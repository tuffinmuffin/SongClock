...
/*!
 *    @brief  Shutdown or enables amp main circuits.
 *    @param  enable
 *            bool
 */
  void Adafruit_TPA2016::shutdown(bool enable) {
    uint8_t setup = read8(TPA2016_SETUP);
  ...
  bool Adafruit_TPA2016::getOverload() {
    uint8_t setup = read8(TPA2016_SETUP);
    return setup && TPA2016_SETUP_THERMAL != 0;
  }
